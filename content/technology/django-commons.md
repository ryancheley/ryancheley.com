...
So far we've been able to migrate 3 libraries[ref][django-tasks-scheduler](https://github.com/django-commons/django-tasks-scheduler)[/ref] [ref][django-typer](https://github.com/django-commons/django-typer)[/ref] [ref][django-fsm-2](https://github.com/django-commons/django-fsm-2)[/ref] into Django Commons. Each one has been a great learning experience, not only for the library maintainers, but also for the Django Commons admins.
